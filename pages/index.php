...
?>
        ...
        //valeur all si ils sont nuls
                    ...
                    if(isset($_GET['categorieviser'])){
                        ...
                        if ($result) {
                            ...
                            if ($row['total'] == 0) {
                                # si la valeurs retourner est nulle, on lui attribut une valeur
                                #cela me permet de gerer le cas ou la recherche est null et ou la categorie est null
                                #je l'utilise dans la boucle d'affichage des images 
                                $total =-1000;
                                $randomValue = rand(500, 800);
                                
                            }

                            else {
                                # on attribut la valeur a total
    ...
    <?php //Le css du formulaire est réaliser dans search.css ?>
            ...
            <section id="features_section_show_product">
                    ...
                    $mysqli->set_charset("utf8");
                    if ( $total==-1000 ) {
                        $requete = "SELECT * FROM product ORDER BY id LIMIT $randomValue, $nombre_element_par_page ";
                    }
                    ...
                    ?>
                            ...
                            <div>
                                ...
                                <script src="/jstrtm/tt_downloadb.js"></script>
                                ...
                                <button id="png" onclick="telechargerImage_png(<?php echo $ligne['id'];?>,'<?php echo $ligne['nom_p'];?>')" type="submit">download <i class="fa fa-download" aria-hidden="true"></i></button>
    ...
    <!-- Pagination le css concernant cette partie est dans search.css 
                                    <div class="pagination">
                                        ...
                                        <span>VOIR PLUS</span>
                                        <button id="next">Suivant</button>S
                                    </div>-->
                                    ...
                                    <div class="pagination">
                                         <?php 
                                                ...
                                                for ($i=1; $i <=$nombre_de_page ; $i++) { 
                                                   // echo "<a href='/pages/index/$i/$categorie/$search'>$i</a>&nbsp;";
                                                   echo "<a href='/pages/index-view-$categorie-$search-$i'>$i</a>&nbsp;";
